...
time_res = "yearly_ltm"
extra_tag = f"timedynamics_{time_res}"  # another distinguishing tag
...
# save vars
file_prefix = f"clim_{dustsp}_{extra_tag}_{fertLevel}Fert_gs+apprate"  # prefix of output run names
...
const_dict = {
    ...
    "duration": 1,  # [yr] duration of run (starts from earliest year)
    "dustsp": dustsp,
    "dustsp_2nd": "amnt",
    ...
    "climatedir": "s3://carbonplan-carbon-removal/ew-workflows-data/scepter/clim/era5_2000-01-01_2020-12-31",
...
dustrate_ton_ha_yr = [1, 10, 20, 40]
dustrad_um = [5, 50, 100, 200]
